...
const es = {
  ...
  work: {
    ...
    items: {
      p1: { name: "Monograma SC", category: "Branding" },
      p2: { name: "Sistema para redes", category: "Social Media" },
      p3: { name: "Piezas en movimiento", category: "Audiovisual" },
      p4: { name: "Línea de producto", category: "Packaging" },
      p5: { name: "Dirección editorial", category: "Editorial" },
      p6: { name: "Composición asistida", category: "IA + Retoque" },
    },
  },
  contact: {
    number: "07",
...
const pt: Dict = {
  ...
  work: {
    ...
    items: {
      p1: { name: "Monograma SC", category: "Branding" },
      p2: { name: "Sistema para redes", category: "Social Media" },
      p3: { name: "Peças em movimento", category: "Audiovisual" },
      p4: { name: "Linha de produto", category: "Packaging" },
      p5: { name: "Direção editorial", category: "Editorial" },
      p6: { name: "Composição assistida", category: "IA + Retoque" },
    },
  },
  contact: {
    number: "07",
...
const en: Dict = {
  ...
  work: {
    ...
    items: {
      p1: { name: "SC Monogram", category: "Branding" },
      p2: { name: "Social system", category: "Social Media" },
      p3: { name: "Pieces in motion", category: "Audiovisual" },
      p4: { name: "Product line", category: "Packaging" },
      p5: { name: "Editorial direction", category: "Editorial" },
      p6: { name: "Assisted composition", category: "AI + Retouch" },
    },
  },
  contact: {
    number: "07",
